...
hidden if the `AlbumArchitect_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `AlbumArchitect_DEVELOPER_MODE` to the configure
...
Runs the executable target `AlbumArchitect_exe`.
